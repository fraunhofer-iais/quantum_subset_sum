...
output_file = os.path.join(project_path, 'data/financial_documents/parsed_assets.jsonl')

factor = 100_000_000
tab = Table()
tab.from_excel(file_path, sheetname="Assets")

# rows of the sheet that contain sums, with corresponding solution
sum_indices_excel = {14: [10, 11, 12, 13],
                     23: [5, 6, 7, 8, 9] + [14, 15, 16, 17, 18, 19, 20, 21, 22]
                     }
