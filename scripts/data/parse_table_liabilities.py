...
output_file = os.path.join(project_path, 'data/financial_documents/parsed_liabilities.jsonl')

factor = 100_000_000
tab = Table()
tab.from_excel(file_path, sheetname="Liabilities")

# rows of the sheet that contain sums, with corresponding solution
sum_indices_excel = {13: [9, 10, 11, 12],
                     21: [6, 7, 8] + [13, 14, 15, 16, 17, 18, 19, 20],
                     26: [23, 24, 25],
                     27: [21, 26]}
